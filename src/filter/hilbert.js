 ...
 */
export function envelope(seis: SeismogramSegment): SeismogramSegment {
  let s = hilbert(seis);
 ...
 */
export function hilbert(seis: SeismogramSegment, n?: number, lowEdge?: number, highEdge?: number ): SeismogramSegment {
  if (! n) { n = 100;}
