 ...
 */
export function envelope(seis: model.Seismogram): model.Seismogram {
  let s = hilbert(seis);
 ...
 */
export function hilbert(seis: model.Seismogram, n: number, lowEdge: number, highEdge: number ): model.Seismogram {
  if (! n) { n = 100;}
