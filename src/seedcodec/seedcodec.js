...
define('seedcodec',
  ...
  var seedcodec = {
    ...
    /** ascii */
    Object.defineProperty(seedcodec, "ASCII", {value : 0});

    /** 16 bit integer, or java short */
    Object.defineProperty(seedcodec, "SHORT", {value : 1});

    /** 24 bit integer */
    Object.defineProperty(seedcodec, "INT24", {value : 2});

    /** 32 bit integer, or java int */
    Object.defineProperty(seedcodec, "INTEGER", {value : 3});

    /** ieee float */
    Object.defineProperty(seedcodec, "FLOAT", {value : 4});

    /** ieee double*/
    Object.defineProperty(seedcodec, "DOUBLE", {value : 5});

    /** Steim1 compression */
    Object.defineProperty(seedcodec, "STEIM1", {value : 10});

    /** Steim2 compression */
    Object.defineProperty(seedcodec, "STEIM2", {value : 11});
    
    /** CDSN 16 bit gain ranged */
    Object.defineProperty(seedcodec, "CDSN", {value : 16});
        
    /** (A)SRO */
    Object.defineProperty(seedcodec, "SRO", {value : 30});
    
    /** DWWSSN 16 bit */
    Object.defineProperty(seedcodec, "DWWSSN", {value : 32});

  seedcodec.decompress = function(compressionType, dataView, numSamples, littleEndian) {
      ...
      switch(compressionType){
          case seedcodec.SHORT:
          case seedcodec.DWWSSN:
              // 16 bit values
          ...
          case seedcodec.STEIM1:
              // steim 1
              out = seedcodec.steim1.decode(dataView, numSamples, littleEndian, 0);
              break;
          case seedcodec.STEIM2:
              // steim 2
              out = seedcodec.steim2.decode(dataView, numSamples, littleEndian, 0);
              break;   
          default:
              // unknown format????
   ...
   *  bytes.
   */
  seedcodec.steim1.decode = function (dataView, numSamples, littleEndian, bias) {
  ...
  function extractSteim1Samples(dataView, offset,  littleEndian) {
	 ...
	 *  bytes.
	 */
	seedcodec.steim2.decode = function (dataView, numSamples, swapBytes, bias) {
		if (dataView.byteLength % 64 != 0) {
			throw "encoded data length is not multiple of 64 bytes (" + b.length + ")"; 
		}
		var samples = [];
