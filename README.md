...
* [displayorganize](https://crotwell.github.io/seisplotjs/api/displayorganize.html) [(source)](https://github.com/crotwell/seisplotjs/blob/version2.0/src/displayorganize.js) organize more complex displays composed of individual pieces
...
* [handlebarshelpers](https://crotwell.github.io/seisplotjs/api/handlebarshelpers.html) [(source)](https://github.com/crotwell/seisplotjs/blob/version2.0/src/handlebarshelpers.js) helpers for use with [handlebars](http://handlebarsjs.com/), eg in titles
...
* [irisfedcatalog](https://crotwell.github.io/seisplotjs/api/irisfedcatalog.html) [(source)](https://github.com/crotwell/seisplotjs/blob/version2.0/src/irisfedcatalog.js) query IRIS fedcatalog web service
...
* [seismogramloader](https://crotwell.github.io/seisplotjs/api/seismogramloader.html) [(source)](https://github.com/crotwell/seisplotjs/blob/version2.0/src/seismogramloader.js) uses fdsnstation, fdsnevent, traveltime and fdsndataselect to load seismograms
