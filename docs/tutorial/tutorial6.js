...
new sp.fdsndatacenters.DataCentersQuery().findFdsnDataSelect("IRISDMC")
...
// snip start heli
    ...
    let seisData = sp.seismogram.SeismogramDisplayData.fromSeismogram(seisArray[0]);
